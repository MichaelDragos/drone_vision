...
# ---------------- Parameters ----------------
WALL_DEPTH_THRESHOLD = 30
MIN_SAFE_DEPTH_FOR_FLIGHT = 34 
SMOOTHING_WINDOW = 60
TAKEOFF_ALTITUDE = 1.5 #use 0.5 for regular copter
YAW_RATE = 0.05  # rad/s

LATERAL_P_GAIN = 0.1   # How strongly to react side-to-side
VERTICAL_P_GAIN = 0.3    # How strongly to react up/down
...
MIN_SPEED = 0.5        # 0.5 -> about 2km/h. 20 -> about 36km/h
DEPTH_RANGE = 15.0     # how much extra depth (above MIN_SAFE) to reach full speed
